          ...
          <div className="establishments-grid">
            ...
            <div className="establishment-card">
              ...
              <div className="est-content">
                ...
                <div className="est-address">São Paulo - Rua Augusta, 1200</div>
                ...
                <div className="est-footer">
                  ...
                  <a
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      navigate("/barbearia/1"); // ✅ navegação
                    }}
                  >
                    Ver horários
                  </a>
            ...
            <div className="establishment-card">
              ...
              <div className="est-content">
                ...
                <div className="est-address">São Paulo - Av. Paulista, 800</div>
                ...
                <div className="est-footer">
                  ...
                  <a
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      navigate("/barbearia/2"); // ✅ navegação
                    }}
                  >
                    Ver horários
                  </a>
