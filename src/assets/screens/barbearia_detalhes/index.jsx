   ...
   return (
     <div className="aurea-container">
       ...
       <div className="studio-banner">
         <div className="studio-banner-bg" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1622286342621-4bd786c2447c?q=80&w=1920&auto=format&fit=crop')" }}></div>
         ...
         <div className="container studio-banner-content">
           ...
           <h1 className="studio-title">Noir Barber Club</h1>
           ...
           <div className="studio-meta">
             <div className="meta-item">
               ...
               São Paulo - Rua Julio Alencar, 505
             </div>
               ...
               <div className="services-list">
                 ...
                 >
                   <div className="service-info">
                     ...
                     <span className="service-time">35 min</span>
                   </div>
